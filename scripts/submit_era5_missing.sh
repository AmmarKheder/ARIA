#!/bin/bash
#SBATCH --job-name=dl_era5_fix
#SBATCH --output=/scratch/project_462001140/ammar/eccv/aria/scripts/dl_era5_fix_%A_%a.out
...
YEARS=(2004 2006 2008 2010 2014 2016)
